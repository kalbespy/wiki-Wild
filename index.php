    ...
    <section id="homeSection">
        <div class="homeSection">
            ...
            <div class="sectionHomeText">
                ...
                <p>PHP est un langage de script utilisé le plus souvent côté serveur : dans cette architecture, le serveur interprète le 
                    code PHP des pages web demandées et génère du code (HTML, XHTML, CSS par exemple) et des données (JPEG, GIF, PNG par exemple) 
                    pouvant être interprétés et rendus par un navigateur web. PHP peut également générer d'autres formats comme le WML, le SVG et 
                    le PDF.</p>
    ...
    <section id="homeSection"> 
        <div class="homeSection">
            ...
            <div class="sectionHomeText">
                ...
                <p>JavaScript est un langage de programmation de scripts principalement employé dans les pages web interactives et à ce titre 
                    ...
                    par les développeurs web. Une grande majorité des sites web l'utilisent4, et la majorité des navigateurs web disposent d'un
                     moteur JavaScript pour l'interpréter.</p>
           ...
           <div class="sectionHomeText">
            <h2>CSS</h2>
                ...
                <p>Les feuilles de style en cascade, généralement appelées CSS de l'anglais Cascading Style Sheets, 
                    ...
                    de sites web et bien pris en charge par les navigateurs web dans les années 2000.</p>
